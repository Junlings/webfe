...
class stylelib():
    ...
    def __init__(self):
        ...
        self.legendlib = {'default':self.default.legend}
    ...
    def load_linelib_color(self):
        ...
        self.add('linelib',3,color='b',marker='+',linestyle='-',markersize=0,linewidth=0.5)
        self.add('linelib',4,color='g',marker='.',linestyle='-',markersize=0,linewidth=0.5)
        self.add('linelib',5,color='y',marker=',',linestyle='-',markersize=0,linewidth=0.5)
        self.add('linelib',6,color='c',marker='d',linestyle='-',markersize=0,linewidth=0.5)
        self.add('linelib',7,color='m',marker='|',linestyle='-',markersize=0,linewidth=0.5)
        self.add('linelib',8,color='k',marker='o',linestyle=':',markersize=0,linewidth=0.5)
        self.add('linelib',9,color='r',marker='v',linestyle=':',markersize=0,linewidth=0.5)
    ...
    def load_linelib_bw(self):
        ...
        self.add('linelib',12,color='k',marker='>',linestyle=':',markersize=4,linewidth=1)
        self.add('linelib',13,color='k',marker='1',linestyle=':',markersize=4,linewidth=1)
        self.add('linelib',14,color='k',marker='2',linestyle=':',markersize=4,linewidth=1)
        self.add('linelib',15,color='k',marker='3',linestyle=':',markersize=4,linewidth=1)
        self.add('linelib',16,color='k',marker='4',linestyle=':',markersize=4,linewidth=1)
        self.add('linelib',17,color='k',marker='s',linestyle=':',markersize=4,linewidth=1)
        self.add('linelib',18,color='k',marker='p',linestyle=':',markersize=4,linewidth=1)
        self.add('linelib',19,color='k',marker='h',linestyle=':',markersize=4,linewidth=1)
        self.add('linelib',20,color='k',marker='H',linestyle=':',markersize=4,linewidth=1)
        self.add('linelib',21,color='k',marker='o',linestyle=':',markersize=4,linewidth=1)
...
def default_style():
    ...
    # line for grid
    pub.add('guidelinelib','default',color='r',linestyle='-',linewidth=0.5)
