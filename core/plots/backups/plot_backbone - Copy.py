...
class plotbackbone():
    ...
    # assembling function for plot settings
    
    def setPlot(self):
        self.setFonts()
        self.setFigure()
        self.setAxes()
        self.setAxis('x1major')
   ...
   # plot manopulation
    ...
    def addPlot(self,axeskey,tshift_x=[None,None],tshift_y=[None,None]):  #target shift
